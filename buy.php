...
<div class="d-flex">  
  <form action="controller/buy.php" method="POST">  
    <label>  
      <span class="fname">  Name <span class="required"> * </span></span> <!--used to group the element for styling purpose-->
    ...
    <div class="Pement">
    <input type="radio" id="one" name="upi"  />
    <label for="one">Cash on Delivery</label>
    <input type="radio" id="one" name="upi"  />
    <label>Scan and Pay</label>
    <img src="images/qr.png" height="180px" width="180px">
    </div>
   </div>
   <button name="buy" type="submit">Submit</button> 
    <button><a href="courses.php" class="signup-image-link">Back</a></button>
     </div>
  </form>  
  </div>  
 </div>  
